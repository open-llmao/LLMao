...
Starting points. ClickHouse docs on materialized views and AggregatingMergeTree are directly relevant. The ClickHouse MCP server is preconfigured if you build a conversational layer.
Suggested demo
